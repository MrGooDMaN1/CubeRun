...
public class OnClickLoadScene : MonoBehaviour
{
    ...
    [SerializeField][Tooltip("The button that allows you to restart the game")] private Button _restartButton;
    ...
    private void Awake()
    {
        if(_activateButton == null || _restartButton == null)
        {
    ...
    private void Start()
    {
        ...
        _restartButton.onClick.AddListener(() => SceneManager.LoadScene(SceneManager.GetActiveScene().buildIndex + 0));
